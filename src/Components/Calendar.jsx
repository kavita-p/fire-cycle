...
const Calendar = (props) => {
  if (props.week === 0) {
    return (<div className="intro text">
      ...
      <p>On the day of Emberdeath, when the flashfire of falling leaves gave way to the soft and deadly cover of snowfall, Grandmother Owl called you to her home. As she shuffled about, she fixed you with her eyes, and studied you for a long, long time in silence.</p>
